...
public class FairSimGUI {
	...
	baseframe = new JFrame("Open-3DSIM");
	...
	final Integer [] pha3Band = new Integer [] {5};
	...
	final Tiles.LComboBox<Integer> nrBands = 
	    new Tiles.LComboBox<Integer>("beams", new Integer [] {3});
	nrBands.box.setSelectedItem(3);
	
	final Tiles.LComboBox<Integer> nrDir = 
	    new Tiles.LComboBox<Integer>("angles", new Integer [] {3});
