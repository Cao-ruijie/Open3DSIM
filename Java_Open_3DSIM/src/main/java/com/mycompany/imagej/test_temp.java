...
//测试类
public class test_temp extends JFrame {
...
//				}
    ...
    private static String showFileOpenDialog (Component parent) {
        ...
        fileChooser.setFileFilter(new FileNameExtensionFilter("image(*.dv, *.tiff, *.tif)", "dv", "tiff", "tif"));
	 ...
	 */
	//public test3() {
	public test_temp() throws MWException {
		...
		btnRead.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {	
				...
				{  	btnRead.setEnabled(false);
					...
					t = t_temp[0];   
					textField_6.setText("Please choose OTF");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        final JFrame jf = new JFrame("测试窗口");
		        output = showFileOpenDialog2(jf);
		        if (output!="0")
		        {textField_5.setText(output);
		        textField_6.setText("Please click Read");}
		        output = output + "\\";
		...
		textField_22.setBounds(74, 17, 43, 21);
		...
		lblNewLabel_3_1_4.setBounds(9, 21, 72, 15);
		...
		lblNewLabel_3_1_4_1.setBounds(124, 21, 72, 15);
